import { FIND_POST_BY_ID_FAILURE, FIND_POST_BY_ID_REQUEST, FIND_POST_BY_ID_SUCCESS, GET_ALL_POSTS_SUCCESS, LIKE_POST_FAILURE, LIKE_POST_REQUEST, LIKE_POST_SUCCESS, RE_POST_FAILURE, RE_POST_REQUEST, RE_POST_SUCCESS, REPLY_POST_SUCCESS, POST_CREATE_FAILURE, POST_CREATE_REQUEST, POST_CREATE_SUCCESS, POST_DELETE_FAILURE, POST_DELETE_REQUEST, POST_GET_USERS_POST_SUCCESS, USER_LIKE_POST_FAILURE, USER_LIKE_POST_REQUEST, USER_LIKE_POST_SUCCESS, POST_DELETE_SUCCESS } from "./ActionType";
...
export const postReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case POST_CREATE_SUCCESS:
            return { ...state, loading: false, error: null, post: [action.payload, ...state.posts] };

        case GET_ALL_POSTS_SUCCESS:
        case POST_GET_USERS_POST_SUCCESS:
